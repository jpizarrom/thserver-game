...
import com.jpizarro.th.server.game.view.web.components.map.MapPanel;
...
public abstract class HomePage extends BasePage {
    ...
    public HomePage() {
    	...
    	add(HeaderContributor.forJavaScript(new ResourceReference(HomePage.class, MAP_MANAGER_URL)));
